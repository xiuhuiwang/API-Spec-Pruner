...
if __name__ == "__main__":
    ...
    # input_file = 'google-gemini-OPENAPI3_0_simplified.json'
    # output_file = 'resolved_google.json'
    # report = 'circular_ref_report_google.json'
    # resolve_openapi_circular_refs(input_file, output_file, report)